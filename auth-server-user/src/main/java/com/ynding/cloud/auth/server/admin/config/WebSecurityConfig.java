...
import com.ynding.cloud.auth.server.admin.config.security.AuthenticationAccessDeniedHandler;
import com.ynding.cloud.auth.server.admin.config.security.CustomMetadataSource;
import com.ynding.cloud.auth.server.admin.config.security.LindTokenAuthenticationFilter;
import com.ynding.cloud.auth.server.admin.config.security.UrlAccessDecisionManager;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers("/", "/index.html", "/ws/**", "/resources/**",
                ...
                // token 请求不做拦截
                .antMatchers("/token/**","/loadUserByUsername")
