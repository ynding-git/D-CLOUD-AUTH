...
insert into oauth_client_details values('orderApp','order-server,gateway','','read,write','password,authorization_code,refresh_token',null,null,3600,3600,null,null);
